window.addEventListener("scroll", function() {
    ...
    if(window.scrollY + document.querySelector("#contact").offsetHeight > (document.querySelector("#home").offsetHeight * 2) + (document.querySelector("#about-me").offsetHeight * 2) + (document.querySelector("#skills").offsetHeight * 2) + (document.querySelector("#testimonials").offsetHeight * 2) + (document.querySelector("#projects").offsetHeight * 2) && window.scrollY + document.querySelector("#contact").offsetHeight < (document.querySelector("#home").offsetHeight * 2) + (document.querySelector("#about-me").offsetHeight * 2) + (document.querySelector("#skills").offsetHeight * 2) + (document.querySelector("#testimonials").offsetHeight * 2) + (document.querySelector("#projects").offsetHeight * 2) + document.querySelector("#contact").offsetHeight) { 
